...
/**
 * @brief       Ribbon Bar CheckBox Plugin
 *
 * @details     Creates instances of the ribbon styled CheckBox
 */
class RibbonCheckBoxPlugin :
    ...
    public QDesignerCustomWidgetInterface {
        ...
        public:
            /**
             * @brief       Constructs a factory capable of creating RibbonCheckBox instances
             *
